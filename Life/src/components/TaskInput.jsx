    ...
    <div className="glass-panel p-4 md:p-5 rounded-2xl w-full border border-white/5 bg-surface/60 backdrop-blur-2xl transition-all hover:bg-surface/80 flex flex-col gap-3">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-3">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center mt-1 gap-3">
          ...
          <button
            type="submit"
            className="bg-primary hover:bg-primary/90 text-white font-semibold px-5 py-2.5 rounded-xl transition-all flex items-center justify-center gap-2 group shrink-0 whitespace-nowrap w-full sm:w-auto sm:min-w-[140px] shadow-lg shadow-primary/20 sm:ml-auto"
          >
